...
![image-20231125154432027](Linux文件系统.assets/image-20231125154432027.png)
...
![image-20231125152628265](Linux文件系统.assets/image-20231125152628265.png)

但DOS类型的分区表最多只支持2TiB

往虚拟机添加一个8000G的硬盘MBR，使用`fdisk`进行分区，会有警告信息，建议使用GPT类型的分区表

![image-20231125195240012](Linux文件系统.assets/image-20231125195240012.png)
...
![image-20231125162732248](Linux文件系统.assets/image-20231125162732248-17009221891534.png)

> df查看磁盘分区的挂载使用情况

对sdb1格式化：`mkfs.xfs /dev/sdb1`

![image-20231125162744595](Linux文件系统.assets/image-20231125162744595.png)
...
![image-20231126101207283](Linux文件系统.assets/image-20231126101207283.png)

软链接，删除原文件，链接文件不可用；硬链接，删除原文件，链接文件可以继续使用，但内容为空

![image-20231126101221410](Linux文件系统.assets/image-20231126101221410.png)